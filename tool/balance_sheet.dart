    ...
    _Sheet(
      ...
      sources: [
        ...
        _Source(
          file: 'enemies',
          path: ['guardians'],
          title: 'Стражи областей',
          about: 'Тот же босс, но в своём логове и в полную силу. Числа у '
              'них свои, потому что роли разные: в бездне босс попадается '
              'каждые несколько этажей и не должен останавливать спуск, а к '
              'стражу игрок приходит нарочно — и вот перед ним и положено '
              'думать, чем идти. Подбираются не на глаз: '
              '`dart run tool/audit_cli.dart --bosses` гоняет четыре '
              'эталонные сборки и четыре «Проводника» против каждого и '
              'требует, чтобы каждого стража ломала хотя бы одна сборка, '
              'каждый сдавался хотя бы одной стихии и ничей профиль не '
              'повторял чужой.',
        ),
      ],
    ),
