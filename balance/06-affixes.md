...
<!-- balance: file=items path=implicits kind=wide -->
| id | название | `base` | `pools.offence` | `pools.utility` | `pools.defence` |
|---|---|---|---|---|---|
| `weapon` | Урон | 5 | 90 | 10 |  |
| `offhand` | Сила чар | 3 | 70 | 30 |  |
| `helmet` | Защита | 8 |  | 35 | 65 |
| `armor` | Защита, HP | 45 |  | 25 | 75 |
| `gloves` | Урон, скорость | 2 | 80 | 20 |  |
| `boots` | Защита, реген | 6 |  | 30 | 70 |
| `ring` | Урон по тегам, сопротивления | 18 | 40 | 20 | 40 |
| `amulet` | Что угодно | 22 | 40 | 25 | 35 |
